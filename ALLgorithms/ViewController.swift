...
import Foundation
/*
 //This was just an idea of using node class as in the c programming language while visualizing algorithims.(This wasn't a good idea for the deadline.)
public class Node{
    var key: Int
    var left: Node?
    var right: Node?
...
class ViewController: UIViewController {
    ...
    var index = 0
    //Definition/Algorithm change switch
